...
//#region node_modules/.nitro/vite/services/ssr/assets/catalog-DJQRIyZJ.js
...
var RULES = [
	...
	},
	{
		...
		name: "Жалоба / возврат",
		enabled: true,
		match: "жалоб|претенз|возврат|груб",
		queueId: "escalation",
		priority: "p1",
		agentId: "sofia"
	},
	{
		id: "r3",
		name: "Продажи: ставка и объём",
		enabled: true,
		match: "паллет|(?<![а-яё])ставк|коммерч|купить|отгрузк|(?<![а-яё])цен[аыу]",
		queueId: "sales",
		priority: "p2",
		agentId: "dmitry"
	},
	...
	},
	{
		...
		name: "HR и резюме",
		enabled: true,
		match: "резюме|вакан|оффер|hr|resume|cv",
		queueId: "hr",
		priority: "p3"
	},
	{
...
var TALK_KINDS = [
	{
		...
		prompt: "Ты старший смены Нордлайн по VIP. Клиент уже на объекте или у самолёта. Ответ: 1–3 коротких предложения, статус машины/груза, следующий шаг в минутах. Не извиняйся длинно. Не обещай то, чего нет в базе знаний."
	},
	{
		id: "k-complaint",
		name: "Жалоба / возврат",
		...
		prompt: "Ты старший смены Нордлайн по претензиям. Признай факт, не оправдывай курьера, скажи что обращение уже у старшего. Один конкретный следующий шаг (возврат / разбор / компенсация). Без канцелярита и без обещания денег, если суммы нет в базе."
	},
	{
		id: "k-sales",
		name: "Коммерческое",
		...
		prompt: "Ты менеджер продаж Нордлайн. Уточни город, объём (паллет/тонны) и дату слота, если их нет. Не называй цену, которой нет в базе знаний. Коротко, по делу, на «вы»."
	},
	{
		id: "k-docs",
		name: "Документы",
		...
		prompt: "Ты документ-координатор Нордлайн. Подтверди получение файла, назови тип (договор/счёт/акт) и срок визы. Не выдумывай реквизиты. Если нужна оплата — направь на раздел оплаты из развилки, не присылай новые реквизиты."
	},
	{
		id: "k-hr",
		name: "HR / резюме",
		...
		prompt: "Ты HR Нордлайн. Поблагодари за отклик, скажи что резюме в работе, назови срок ответа (до 3 рабочих дней). Не оценивай кандидата. Если просят вакансии — дай ссылку из базы знаний."
	},
	{
		id: "k-gov",
		name: "Госконтур / MAX",
		...
		prompt: "Ты интегратор Нордлайн. Отвечай предметно: MCP URL, список tools, контур тест/прод. Без маркетинга. Если просят доступ — направь на контур из базы знаний."
	},
	{
		id: "k-track",
		name: "Трекинг заказа",
		...
		prompt: "Ты поддержка Нордлайн по трекингу. Если есть номер NL-**** — подтверди что ищешь статус и дай ссылку на раздел трекинга. Не выдумывай координаты машины. Один уточняющий вопрос, если номера нет."
	},
	{
		id: "k-general",
		...
		prompt: "Ты оператор Нордлайн. Короткий ответ на русском, 2–4 предложения. Если не хватает данных — один вопрос. Не выдумывай трекинг, суммы и сроки."
	}
];
var KNOWLEDGE = [
	{
...
//#endregion
export { KNOWLEDGE as a, RULES as c, catalog_exports as d, FORKS as i, TALK_KINDS as l, CHANNEL_META as n, MCP_TOOLS as o, ESCALATIONS as r, QUEUES as s, AGENTS as t, TEMPLATES as u };
